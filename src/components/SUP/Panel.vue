      ...
      <div class="space-y-2">
        ...
        >
          ...
          <button
            ...
            class="cursor-pointer ml-2 p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded transition-colors"
          ...
          >
            <button
              ...
              class="cursor-pointer w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center"
            >
            ...
            <button
              ...
              class="cursor-pointer w-full px-4 py-2 text-left text-red-600 hover:bg-gray-50 flex items-center"
            >
