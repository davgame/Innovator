<template>
  <div class="flex gap-6 px-4 pb-4 h-[calc(100vh-140px)] overflow-x-auto overflow-y-hidden">

    <!-- Колонка -->
    <div
      v-for="column in columns"
      :key="column.id"
      class="w-82 rounded-2xl p-4 flex flex-col flex-shrink-0 bg-gray-50 min-h-0"
    >
